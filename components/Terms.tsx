...
const TermsAndConditions = () => {
  return (
    <div className="min-h-screen  flex flex-col items-center pt-10 bg-gradient-to-r from-[rgba(63,97,173,0.24)] via-[rgba(168,76,156,0.24)] to-[rgba(238,54,77,0.24)]">
      <div className="text-center ">
        <h1 className="text-[#28456F] font-bold font-['Segoe_UI'] text-[66px] leading-[122.502%]">
          Terms and Conditions
        </h1>
        <div className='lists pt-10 px-36'>
        <ul className="text-[#3C3C41] font-['Segoe_UI'] text-[16px] leading-[123%] mt-4 text-left list-disc space-y-4">
