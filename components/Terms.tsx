    ...
    <div className="min-h-screen flex flex-col items-center pt-10 bg-gradient-to-r from-[rgba(63,97,173,0.24)] via-[rgba(168,76,156,0.24)] to-[rgba(238,54,77,0.24)] px-4 lg:px-0 pb-10 lg:pb-24">
      <div className="text-center max-w-5xl">
        ...
        <div className="lists pt-8 sm:pt-10 px-4 sm:px-8 lg:p">
          <ul className="text-[#3C3C41] font-['Segoe_UI'] text-sm sm:text-base md:text-[14px]  font-[400] leading-relaxed md:leading-[123%] mt-4 text-left list-disc space-y-4">
            ...
            <li>The participant/winner/content shall be disqualified:
              <ul className="list-none pl-4 sm:pl-6 space-y-2">
