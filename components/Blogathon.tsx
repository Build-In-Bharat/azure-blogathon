  ...
  return (
    <div id='about' className="relative pt-12 xl:pt-24 xl:pb-36 pb-48">
      ...
      <div className='flex flex-col md:flex-row justify-center items-center px-4 md:px-0'>
          <div className="relative z-20 p-[10px] w-[90%] md:w-[30vw] -mb-12 md:-mb-48" style={{backgroundImage: "url('/second-third.png')", backgroundSize: 'contain', backgroundRepeat: 'no-repeat'}}>
            <div className='bg-white py-5 px-4 md:px-8'>
                <div className='text-[#28456F] text-3xl md:text-[44px] leading-tight md:leading-[50px] font-bold text-center mb-5'>Themes & Topics</div>
                <div className='text-[#3C3C41] text-center text-sm md:text-[16px] flex flex-col gap-3'>
          ...
          <div className="relative z-10 md:-ml-16 p-[12px] w-[90%] md:w-[45vw] mt-4 md:mt-0" style={{backgroundImage: "url('/second-one.png')", backgroundSize: 'contain', backgroundRepeat: 'no-repeat'}}>
